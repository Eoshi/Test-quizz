...
<body class="bg-indigo-700 min-h-screen text-white font-sans overflow-hidden">
    ...
    <div id="question-ui" class="hidden flex flex-col h-screen">
        ...
        <div class="flex items-center justify-around py-4 bg-indigo-900 border-t border-indigo-500 z-20">
            <div id="timer" class="text-5xl font-black bg-white text-indigo-700 w-24 h-24 rounded-full flex items-center justify-center border-4 border-white">0</div>
            <div class="text-center"><p id="ans-count" class="text-6xl font-black">0</p><p class="text-xs font-bold opacity-50 uppercase">Réponses</p></div>
        </div>
        <div class="grid grid-cols-2 gap-2 p-2 h-1/4">
            <div class="bg-red-500 rounded-xl p-4 text-xl font-bold italic shadow-lg">▲ <span id="opt1" class="ml-3 font-normal"></span></div>
            <div class="bg-blue-500 rounded-xl p-4 text-2xl font-bold italic shadow-lg">◆ <span id="opt2" class="ml-3 font-normal"></span></div>
            <div class="bg-yellow-500 rounded-xl p-4 text-xl font-bold italic shadow-lg">● <span id="opt3" class="ml-3 font-normal"></span></div>
            <div class="bg-green-500 rounded-xl p-4 text-xl font-bold italic shadow-lg">■ <span id="opt4" class="ml-3 font-normal"></span></div>
        </div>
    </div>
    ...
    <div id="leaderboard-ui" class="h-screen hidden flex flex-col items-center justify-center bg-indigo-900 p-10 relative">
        ...
        <div class="flex gap-4 mt-10 z-20">
            <button id="next-btn" onclick="nextStep()" class="bg-green-500 text-white px-12 py-4 rounded-full font-black text-2xl shadow-2xl transition hover:scale-105">SUIVANT</button>
